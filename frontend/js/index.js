...
async function processImage() {
    ...
    try {
        ...
        console.log('Processing image with effect:', document.getElementById('effectSelect').value);
        ...
        document.getElementById('processedImage').src = `${API_BASE_URL}${result.processed_url}`;
