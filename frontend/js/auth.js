...
function updateNav() {
  ...
  if (token) {
    navLinks.innerHTML = `
            ...
            <li><a href="history.html"><i class="fas fa-chart-bar"></i> Dashboard</a></li>
...
function displayImageHistory(history) {
  ...
  if (history.length === 0) {
    historyContainer.innerHTML =
      '<p class="no-history">No image processing history found. Process some images first!</p>';
    return;
  }
    ...
    html += `
      ...
      item.processed_url
                ...
                <div class="history-info">
                    ...
                    <button class="btn-download history-download" data-url="${API_BASE_URL}${
      item.processed_url
    }">
